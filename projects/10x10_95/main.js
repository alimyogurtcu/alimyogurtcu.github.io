...
function run(v, t) {
  ...
  if(createTable(tempTable1,1,bool,create,x,y) > createTable(tempTable2,1,!bool,create,x,y)){
    createTable(mainTable,i,bool,!create,x,y)
  } else createTable(mainTable,i,!bool,!create,x,y)

  // 100'e kadar sayılması ve tablo oluşurulması
  function createTable(tableName,i,bool,create,x,y) {
    lastNumber = 0;
    while (i <= 99) {
      ...
      try {
        ...
        if(create) unsuccesfull.push([i,x,y])
        break;
      }
